...
while True:
    inputthingy = input('what is the folder location of the files: ').lower()
    value = exists(inputthingy)
    if inputthingy == "exit":
        exit()
    if value == False:
        print("sorry the file location doesn't exist. Try implementing one that does")
        continue
    elif value == True:
